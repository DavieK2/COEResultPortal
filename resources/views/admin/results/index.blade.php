...
<body class="bg-gray-100">
    ...
    <div id="sideBar"
        class="tw:md:fixed bg-white border-r border-gray-300 p-6 w-64 z-30 tw:bottom-0 tw:h-[calc(100vh-5rem)] shadow-xl animated faster tw:overflow-y-auto">
    ...
    <!-- strat wrapper -->
    <div
        class="tw:h-[calc(100vh-5rem)] tw:fixed tw:md:right-0 tw:bottom-0 tw:overflow-y-auto tw:w-full tw:md:w-[calc(100vw-16rem)]">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table-auto w-full mt-5 text-right">
                                ...
                                <thead>
                                    <tr class="">
                                        <td class="px-4 py-4 font-extrabold text-sm text-left tw:bg-gray-200">Course</td>
                                ...
                                <tbody>
                                    ...
                                    <!-- item -->
                                    <tr class="">
                                        <td class="px-4 py-4  text-sm text-gray-600 flex flex-row items-center text-left">Sneakers and Tennis</td>
                                        <td class="py-4 text-xs text-gray-600 text-left">$ <span class="num-2"></span></td>
                                        <td class="py-4 text-xs text-gray-600 text-left"><span class="num-3"></span></td>
                                        <td class="py-4 text-xs text-gray-600 text-left">$ <span class="num-4"></span></td>
                                        <td class="py-4 text-xs text-gray-600 text-left">$ <span class="num-4"></span></td>
                                        <td class="py-4 text-xs text-gray-600 text-left">$ <span class="num-4"></span></td>
                                        <td class="py-4 text-xs text-gray-600 text-left">$ <span class="num-4"></span></td>
                                    </tr>
